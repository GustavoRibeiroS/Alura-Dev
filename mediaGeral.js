...
function calculaMedia(notasSala) {
    const somaDasNotas = notasSala.reduce((acumulador, nota) => { //acumulador recebe o valor 0 e na nota é atribuido os valores dos arrays das salas que serão passadas como parâmetro
